...
String _password;
TextEditingController controelr = new TextEditingController();
...
//        onSaved: saveField,
  ...
  Widget build(BuildContext context) {
    ...
    var _passwordField =
    buildTextFormField('passwordField', passwordDecoration, passwordPaddingInfo,
        null, null, controller:controelr,
